        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.message == "found data") {
                    ...
                    document.getElementById("resultado6_1").innerText = "Nombre Madre: " + response.result.nomMadre
                    document.getElementById("resultado6_2").innerText = "Nombre Padre: " + response.result.nomPadre
